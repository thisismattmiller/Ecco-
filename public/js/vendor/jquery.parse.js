...
(function($)
{
	...
	$.parseFile = function(f,config, doneCallback, errorCallback)
	{

		var streamer = new Streamer(f,config);

		streamer.stream(doneCallback,errorCallback);
